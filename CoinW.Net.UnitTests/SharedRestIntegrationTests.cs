...
namespace CoinW.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private ICoinWRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddCoinW(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<ICoinWRestClient>().SpotApi.SharedClient;
        }

        private ICoinWRestClientFuturesApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddCoinW(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<ICoinWRestClient>().FuturesApi.SharedClient;
        }
