...
namespace CoinW.Net.Converters
{
    ...
    [JsonSerializable(typeof(CoinWResponse<CoinWTradeHistory>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWMarginRequirementWrapper>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWOrderId>))]
    [JsonSerializable(typeof(CoinWResponse))]
    [JsonSerializable(typeof(CoinWFuturesOrderRequest[]))]
    [JsonSerializable(typeof(CoinWResponse<CoinWBatchResult[]>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWEditResult>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWFuturesOrderPage>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWHistOrderPage>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWValue>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWPosition[]>))]

    [JsonSerializable(typeof(long[]))]
    [JsonSerializable(typeof(Dictionary<string, object>[]))]
    [JsonSerializable(typeof(CoinWSpotSocketRequest))]
    [JsonSerializable(typeof(CoinWFuturesSocketRequest))]
    ...
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesTickerUpdate>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesOrderBook>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesTrade[]>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesStreamKline>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWPrice>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFundingRate>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesOrder[]>))]
