...
namespace CoinW.Net.Converters
{
    ...
    [JsonSerializable(typeof(CoinWResponse<CoinWPositionHistoryPage>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWMaxTrade>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWFuturesTransactionPage>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWFuturesBalance>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWFees>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWMaxPosition>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWTpSl[]>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWTrailingTpSl[]>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWMarginInfo>))]
    [JsonSerializable(typeof(CoinWResponse<CoinWFuturesOrder[]>))]
    ...
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWPosition[]>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWPositionChange[]>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesBalance[]>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWMarginInfo[]>))]
    [JsonSerializable(typeof(CoinWSocketResponse<CoinWFuturesBalanceUpdate[]>))]
