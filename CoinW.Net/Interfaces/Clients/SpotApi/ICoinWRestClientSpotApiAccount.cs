...
namespace CoinW.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface ICoinWRestClientSpotApiAccount
    {
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/get-spot-account-balance" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/get-total-spot-account-balance" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/get-deposit-withdrawal-history" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/get-deposit-withdrawal-address" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/initiate-withdrawal" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        /// <param name="asset">["currency"] The asset, for example `ETH`</param>
        /// <param name="quantity">["amount"] Quantity to withdraw</param>
        /// <param name="address">["address"] Address to withdraw to</param>
        /// <param name="network">["chain"] Network to use</param>
        /// <param name="memo">["memo"] Memo</param>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/cancel-withdrawal" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        ...
        /// <para>
        /// Docs:<br />
        /// <a href="https://www.coinw.com/api-doc/en/spot-trading/account/transfer-assets" /><br />
        /// Endpoint:<br />
        /// POST /api/v1/private
        /// </para>
        /// </summary>
        /// <param name="fromAccount">["accountType"] From account type</param>
        /// <param name="toAccount">["targetAccountType"] To account type</param>
