...
GitHub Copilot and Cursor instructions are also provided in `.github/copilot-instructions.md` and `.cursor/rules/coinw-net.mdc`; both point back to the root AI context files.
...
* Version 2.9.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to CoinWCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new CoinWCredentials(..)`
...
* Version 2.4.0 - 06 Feb 2026
    ...
    * Added CoinWUserSpotDataTracker and CoinWUserFuturesDataTracker
...
* Version 2.3.0 - 22 Jan 2026
    ...
    * Added Metadata to CoinWExchange
